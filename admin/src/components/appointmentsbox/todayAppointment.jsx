...
function TodayAppointment() {
    ...
    axios
      ...
      .then((result) => {
        const todayReservations = result.data.filter((reservation) => {
          ...
          const appointmentDate = new Date(reservation.startDate).toDateString();
  ...
  return (
    <div className="table-responsive">
      <h1 className="text-white p-2">Today Reservation</h1>

      <p>
        Total Confirmed Reservations: {confirmedCount} | Total Not Confirmed
        Reservations: {notConfirmedCount}
      </p>
